...
// поле пошуку
searchBox.addEventListener("input", (0, _lodashDebounceDefault.default)(inputHandler, DEBOUNCE_DELAY));
...
function inputHandler(event) {
    ...
    //оброблення промісу
    (0, _fetchCountries.fetchCountries)(Input).then((data)=>{
        data.length > 10 ? (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name") : renderMarkup(data);
    }).catch(()=>{
        [
            countryList,
            countryInfo
        ].forEach(cleanMarkup);
        (0, _notiflixDefault.default).Notify.failure("Oops, there is no country with that name"); // Обробка помилки.
    });
}
// рендерення розмітки
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","./fetchCountries":"fTQqv"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
/**
...
const fetchCountries = (name)=>{
    ...
    return fetch(url).then((response)=>{
        if (!response.ok) throw new Error(`404 not found: ${response.statusText}`);
        return response.json();
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequireabb0")
